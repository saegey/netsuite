...
module NetSuite
  ...
  module Namespaces
    ...
    autoload :ListEmpType,    'netsuite/namespaces/list_emp_type'
  ...
  module Records
    ...
    autoload :EmployeeHrEducation,        'netsuite/records/employee_hr_education'
    autoload :EmployeeHrEducationList,    'netsuite/records/employee_hr_education_list'
    autoload :EmployeeEmergencyContact,   'netsuite/records/employee_emergency_contact'
    autoload :EmployeeEmergencyContactList, 'netsuite/records/employee_emergency_contact_list'
    autoload :EmployeeRoles,              'netsuite/records/employee_roles'
    autoload :EmployeeRolesList,          'netsuite/records/employee_roles_list'
